  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 p-6 lg:p-8 space-y-6 bg-[#fcfdfe] min-h-screen">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-6">
        <div>
          <nav className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.2em] text-[#8B1538] mb-1">
            <span>Identity Hub</span>
            <span className="text-gray-300">/</span>
            <span className="text-gray-400">Public Profile</span>
          </nav>
          <h1 className="text-xl font-black tracking-tight text-black uppercase">Personal Presence</h1>
          <p className="text-[11px] text-gray-500 mt-1 font-bold">
            Institutional digital identity visible to the university community.
          </p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" className="h-10 px-6 rounded-xl border-gray-100 text-gray-500 font-black text-[10px] hover:bg-white hover:border-rose-200 transition-all uppercase tracking-widest shadow-sm">
            View Public
          </Button>
          <Button className="bg-primary hover:bg-primary/90 text-white font-black h-10 px-6 rounded-xl shadow-lg shadow-primary/10 transition-all hover:scale-[1.02] uppercase tracking-widest text-[10px]">
            Edit Profile
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl">
        ...
        <div className="lg:col-span-4 space-y-8">
          <Card className="border-none shadow-xl shadow-gray-200/30 bg-white rounded-[1.5rem] overflow-hidden">
            <div className="h-24 bg-gradient-to-br from-[#5A0F23] to-[#8B1538] relative">
              ...
              <div className="-mt-12 relative z-10 flex flex-col items-center">
                <div className="p-1.5 bg-white rounded-2xl shadow-xl shadow-primary/5">
                  <Avatar className="h-24 w-24 rounded-xl border-none">
                    <AvatarImage src="" />
                    <AvatarFallback className="bg-rose-50 text-primary text-2xl font-black">AD</AvatarFallback>
                  </Avatar>
                </div>
                <div className="mt-4 text-center">
                  <h2 className="text-lg font-black text-black tracking-tight">Admin User</h2>
                  <p className="text-[9px] font-black text-primary uppercase tracking-widest mt-1">System Architecture Lead</p>
                </div>
              </div>
              ...
              <div className="mt-8 space-y-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-gray-50/50 border border-transparent group hover:bg-white hover:border-gray-100 transition-all">
                    <item.icon className="h-3.5 w-3.5 text-gray-400 group-hover:text-primary" />
                    <div>
        ...
        <div className="lg:col-span-8 space-y-8">
          <Card className="border-none shadow-xl shadow-gray-200/30 bg-white rounded-[1.5rem] overflow-hidden">
            <CardHeader className="p-8 pb-4 border-none">
              <span className="text-[9px] font-black uppercase tracking-widest text-primary mb-1 block">Account Insights</span>
              <CardTitle className="text-xl font-black text-black tracking-tight">Active Overview</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-0 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="p-6 rounded-[1.25rem] bg-rose-50/40 border border-rose-100/50 space-y-3 group hover:bg-white hover:shadow-lg transition-all">
                  <div className="h-10 w-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-[#8B1538]">
                     <Shield className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-sm font-black text-black tracking-tight">Encryption Layers</p>
               ...
               <div className="p-6 rounded-[1.25rem] bg-rose-50/40 border border-rose-100/50 space-y-3 group hover:bg-white hover:shadow-lg transition-all">
                  ...
                  <div>
                    <p className="text-sm font-black text-black tracking-tight">Privilege Level</p>
          ...
          <Card className="border-none shadow-xl shadow-gray-200/30 bg-white rounded-[1.5rem] overflow-hidden">
            <CardHeader className="p-8 pb-2 border-none flex flex-row items-center justify-between">
              <div>
                <span className="text-[9px] font-black uppercase tracking-widest text-primary mb-1 block">Security Traffic</span>
                <CardTitle className="text-lg font-black text-black tracking-tight">Active Sessions</CardTitle>
              </div>
              <Button variant="ghost" className="text-[9px] font-black uppercase tracking-widest text-gray-400 hover:text-red-600">
                View Logs
              </Button>
            </CardHeader>
               ...
               {[
                 ...
                 <div key={i} className="flex items-center justify-between p-5 px-8 border-b border-gray-50 last:border-0 hover:bg-gray-50/30 transition-all group">
                    <div className="flex items-center gap-4">
                       <div className={cn("h-10 w-10 rounded-xl flex items-center justify-center transition-all", session.active ? "bg-red-600 text-white shadow-lg shadow-red-100" : "bg-gray-100 text-gray-400")}>
                          <UserIcon className="h-4 w-4" />
                       </div>
                       <div>
                          <p className="text-xs font-black text-black uppercase tracking-tight">{session.device}</p>
