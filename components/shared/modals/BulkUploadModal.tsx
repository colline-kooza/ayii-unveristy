      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden rounded-2xl border-none shadow-2xl">
        <div className="bg-blue-600 p-8 text-white relative">
            ...
            <DialogHeader>
                ...
                <p className="text-blue-100 text-sm mt-2">Upload a CSV file to create multiple student accounts at once.</p>
            </DialogHeader>
        </div>
        ...
        <div className="p-8 space-y-6">
            <button 
                ...
                className="w-full flex items-center justify-between p-4 border border-blue-100 bg-blue-50/50 rounded-xl hover:bg-blue-50 transition-colors group"
            >
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                        <p className="text-sm font-bold text-blue-900 leading-none">Download Template</p>
                        <p className="text-[10px] text-blue-600 mt-1 uppercase tracking-wider font-medium">Standard format required</p>
                    </div>
                </div>
            ...
            <div 
                ...
                className={cn(
                    ...
                    file ? "border-green-300 bg-green-50/30" : "border-gray-200 hover:border-blue-400 hover:bg-blue-50/30"
                )}
            >
                <input 
                    type="file" 
                ...
                {file ? (
                    ...
                    <>
                        <div className="bg-gray-100 p-4 rounded-full text-gray-400 group-hover:text-blue-500 transition-colors">
                            <Upload className="h-8 w-8" />
                        </div>
                        <div>
                            <p className="text-sm font-bold text-gray-900 group-hover:text-blue-600 transition-colors">Select your CSV file</p>
            ...
            <div className="space-y-4">
                ...
                <Button 
                    ...
                    className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg shadow-blue-100 transition-all flex items-center justify-center gap-2"
                >
