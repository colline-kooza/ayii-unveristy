  ...
  useEffect(() => {
    if (student) {
      reset({
        ...
        image: student.image || student.avatarUrl || "",
      });
    }
  }, [student, reset]);
      ...
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-2xl">
        <div className="bg-blue-600 p-6 text-white relative overflow-hidden">
          ...
          <DialogHeader className="relative z-10">
            ...
            <p className="text-blue-100 text-sm mt-1">Update global profile and institutional records</p>
          </DialogHeader>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 bg-white space-y-6">
          <div className="flex justify-center -mt-16 relative z-20">
            <div className="p-1 bg-white rounded-2xl shadow-xl">
              <R2ImageUpload
                identifier={`student-avatar-${student?.id}`}
                value={image || ""}
          ...
          <div className="space-y-5">
             ...
             <div className="p-4 bg-gray-50 border border-gray-100 rounded-2xl flex items-center justify-between">
                <div className="flex flex-col">
                   ...
                   <span className="text-lg font-black text-blue-600 font-mono tracking-tighter">{student?.registrationNumber}</span>
                </div>
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                ...
                <Input 
                  id="name" 
                  {...register("name")} 
                  className="pl-10 h-11 border-gray-100 focus:border-blue-500 transition-all rounded-xl"
                />
              </div>
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    id="email" 
                    {...register("email")} 
                    className="pl-10 h-11 border-gray-100 focus:border-blue-500 transition-all rounded-xl text-sm"
                  />
                </div>
          ...
          <div className="flex items-center gap-3 pt-4">
             ...
             <Button 
                type="submit" 
                disabled={isLoading} 
                className="h-11 flex-[2] bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg shadow-blue-200 transition-all flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
