...
const contentSchema = z.object({
  ...
  type: z.enum(["PAST_PAPER", "JOURNAL", "NEWSPAPER", "BOOK"]),
...
const CONTENT_TYPES = [
  ...
  { value: "NEWSPAPER", label: "University Newspaper", description: "Weekly news and official announcements" },
      ...
      <DialogContent className="sm:max-w-[550px] p-0 overflow-hidden rounded-2xl border-none shadow-2xl">
        <div className="bg-slate-900 p-8 text-white relative">
            ...
            <DialogHeader>
                ...
                <p className="text-slate-400 text-sm mt-2">Publish new academic resources to the university digital library.</p>
            </DialogHeader>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-6 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <Input 
                    ...
                    className="h-11 border-slate-100 rounded-xl focus:ring-4 focus:ring-blue-50/50"
                />
          ...
          <div className="flex justify-end pt-6 border-t border-slate-50 gap-3">
